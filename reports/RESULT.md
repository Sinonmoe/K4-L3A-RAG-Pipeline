...
| 2 | How much does each assessment criterion contribute to the IELTS essay score? | B | 0.000 | 0.000 | 0.000 | 1.000 | retrieval | Chunk đáp án `article_02.md::chunk-5` (25%) ở hạng 5 của dense bị RRF loại khỏi top five, thay bằng `article_02.md::chunk-1`. Model trả lời không có citation nên bị validator từ chối. Precision vẫn bằng 1.0 dù context thiếu đáp án; đây là điểm bất thường của judge chưa được điều tra, nên không dùng precision riêng lẻ để kết luận. Config A xử lý đúng case này (1.0/0.81/1.0/0.70). |
